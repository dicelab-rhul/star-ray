...
class WebServerBase:
    ...
    def register_routes(self):
        self._app.get("/")(self.serve_index)
        self._app.get("/static/{namespace}/{filename}")(self.serve_template)
...
uvicorn.run(server._app, host="localhost", port=8888, log_level="info")
